export const USERS_BUTTON =  {
   ...
   STARTED_OLD: {
      ...
      ABOUT: {
         TEXT: 'О котиках', ACTION: 'about_action'
      },
      PROMO: {
   ...
   INLINE_GRILL_BREAKFAST: {
      ...
      EGGS: {
         TEXT: 'Яйца пашот ', ACTION: 'menu_grill_eggs'
      },
      TOSTS: {
   ...
   INLINE_GRILL_MAIN: {
      ...
      FISH: {
         TEXT: 'Рыба ', ACTION: 'menu_grill_fish'
      },
      BURGER: {
         TEXT: 'Бургеры ', ACTION: 'menu_grill_burger'
      },
      GARNISH: {
      ...
      SAUSE: {
         TEXT: 'Соус', ACTION: 'menu_grill_sause'
      },
   },
   ABOUT: {
      MAIN: {
